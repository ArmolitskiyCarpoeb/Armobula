/datum/job/vesta/captain
	...
	outfit_type = /decl/hierarchy/outfit/job/vesta/captain
	min_skill = list(
...
/datum/job/vesta/captain/equip_job(var/mob/living/carbon/human/H, var/alt_title, var/datum/mil_branch/branch, var/datum/mil_rank/grade)
	. = ..()
	if(H)
...
/datum/job/vesta/hop
	...
	outfit_type = /decl/hierarchy/outfit/job/vesta/hop
	head_position = 1
