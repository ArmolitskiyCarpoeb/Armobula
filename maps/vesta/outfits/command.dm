/decl/hierarchy/outfit/job/vesta/captain
	name = "vesta - Job - Captain"
...
/decl/hierarchy/outfit/job/vesta/captain/Initialize()
	. = ..()
...
/decl/hierarchy/outfit/job/vesta/captain/post_equip(var/mob/living/carbon/human/H)
	..()
	if(H.get_age() > 20)
...
/decl/hierarchy/outfit/job/vesta/hop
	name = "vesta - Job - Lieutenant"
