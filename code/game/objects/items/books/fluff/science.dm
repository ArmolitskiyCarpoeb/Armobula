...
/obj/item/book/fluff/novotheism_bible
	name = "Откровение Святого Клесконта"
	icon = 'icons/obj/items/books/book_stasis.dmi'
	author = "Свидетели Откровения"
	title = "Откровение Святого Клесконта"
	fluff_text = {"
		<h1><a name="Foreword"></a>Откровение</h1>
		<p>Все людские души попадут в Чистилище, ибо верили в ложного Бога. Им уготован бесконечно длинный срок, однако для праведных и богобоязненных очищение станет менее мучительным.</p>
		<p>Истинный Творец требует почитания и не терпит ереси.</p>
		<h1><a name="Development"></a>Ритуалитет</h1>
		<ol>
		<li><strong>Молитва.</strong> Возможна в любом месте, однако Богу лучше слышна именно из церкви. В конце обязательно добавить <em>"Хтиэд"</em></li>
		<li><strong>Причащение.</strong> Кровью и плотью. Подходит любая, кроме искусственной. Во время процессии следует сначала сказать: <em>"Аз'Арздивхиэ Фтх Ниэ'Кхтир"</em>, а в конце: <em>"Хтиэд"</em></li>
		<li><strong>Жертвоприношение.</strong> Самое малое: животное или часть тела человека. Самое действенное - человек. Во время процессии следует повторять: <em>"Ар'Здгани'Ир Хт Ифгхта'Ахиэ"</em></li>
		</ol>
	"}
