...
/obj/machinery/media/jukebox/proc/StartPlaying()
	...
	sound_token = play_looping_sound(src, sound_id, current_track.GetTrack(), volume = volume, range = 10, falloff = 5, prefer_mute = TRUE, preference = /datum/client_preference/play_game_music, streaming = TRUE)
