...
/datum/level_data/main_level/vesta
...
/datum/level_data/main_level/vesta/get_subtemplate_areas(template_category, blacklist, whitelist)
    return submap_area ? (islist(submap_area) ? submap_area : list(submap_area)) : null

/datum/level_data/main_level/vesta/get_subtemplate_budget()
    return submap_budget

/datum/level_data/main_level/vesta/get_subtemplate_category()
    return submap_category

/obj/abstract/level_data_spawner/vesta
	level_data_type = /datum/level_data/main_level/vesta

//datum/daycycle/shaded_hills
//	cycle_duration = 2 HOURS // 1 hour of daylight, 1 hour of night

/datum/level_data/main_level/vesta/after_generate_level()
	. = ..()
...
/datum/level_data/main_level/vesta/caves
	name = "Vesta - Caves"
...
/obj/abstract/level_data_spawner/vesta_caves
	level_data_type = /datum/level_data/main_level/vesta/caves

/*
/datum/level_data/main_level/vesta/caves/after_generate_level()
	var/datum/random_map/M = /datum/random_map/noise/forage/acheron/caves
	M.set_origins(0,0,0)
	M.apply_to_map()
	return ..()
*/